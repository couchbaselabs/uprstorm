...
public final class SlidingWindowCounter<T> implements Serializable {
  ...
  public void incrementCount(T obj, Long id) {
    objCounter.incrementCount(obj, headSlot, id);
  }
   ...
   */
  public Map<T, ResultObj> getCountsThenAdvanceWindow() {
    Map<T, ResultObj> counts = objCounter.getCounts();
  ...
  private void advanceHead() {
    ...
    LOG.debug("Advanced Head to "+headSlot);
  }
