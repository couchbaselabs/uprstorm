...
public class RankableObjectWithFields implements Rankable, Serializable {
  ...
  public RankableObjectWithFields(Object obj, long count, Long id, Object... otherFields) {
    if (obj == null) {
  ...
  public static RankableObjectWithFields from(Tuple tuple) {
    ...
    return new RankableObjectWithFields(obj, count, id, otherFields.toArray());
  }
  ...
  public Rankable copy() {
    ...
    return new RankableObjectWithFields(getObject(), getCount(), getId(), shallowCopyOfFields);
  }
